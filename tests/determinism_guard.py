...
PROD_WIDTH = 220
PROD_HEIGHT = 160
GOLDEN_PROD = "ac16853b32e3fc743e9cdc995230d343640bc34aeb3289a57c881a0e149613f8"  # regold P5 E1 CULTES 2026-07-21 (ex-d9294cd1). Imputation CULTURE_OFF → d9294cd1 EXACT. P5 E2 FÊTE : INCHANGÉ (3000t < automne 3600t) ; FEAST_OFF idem. P5 E3 MONUMENTS : INCHANGÉ (pas d'Acier @3000t) ; MONUMENT_OFF idem. P5 E4 HÉROS : INCHANGÉ (pas de héros @3000t) ; HEROES_OFF idem. P6 F1 OR-MONNAIE : INCHANGÉ (pas d'or @3000t) ; MONEY_OFF idem. REGOLD P6 F2 2026-07-28 (ex-3d70b047) : wire wealth (pop 757 inchangée). ECON_OFF → 3d70b047 EXACT. P6 F3 SENTIERS + F4 GRENIERS : INCHANGÉ (pas de moulin L2 @3000t) ; TRAILS_OFF/GRANARY_OFF idem. REGOLD P7 G1 CARTOGRAPHIE 2026-07-31 (ex-8eff7ae1) : expéditions d'éclaireurs (un éclaireur détaché par clan, marche persistante, découverte de sites) → trajectoire réellement modifiée (pop 757→752). Imputation EXPLO_OFF (= CARTO_OFF) → 8eff7ae1 (pré-P7) EXACT.
