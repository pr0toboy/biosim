...
GOLDEN_CIV = "2477001a0d1ba963b6352511d27e20853b30bb16a6e54c9a307cbb0f25ea0c41"  # regold P5 E4 HÉROS 2026-07-21 (ex-114dd533 E3 ; des héros sont nommés dans le CIV Acier → wire hero + events hero_named/fallen ; E4 behavior-neutre → MÊME pop 1150, seul le wire diffère). E1-E4 tous exercés par le guard. Imputation HEROES_OFF → 114dd533 (E3) EXACT ; MONUMENT_OFF → e993593e (E2) ; CULTURE_OFF → 4b0c9df8 (pré-P5).
